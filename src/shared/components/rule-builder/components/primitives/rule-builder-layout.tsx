...
export const RuleBuilderSection = forwardRef<HTMLElement, HTMLAttributes<HTMLElement>>(({ className, ...props }, ref) => (
...
export const RuleBuilderRows = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
	<div ref={ref} className={cn('flex flex-col gap-1', className)} {...props} />
));
RuleBuilderRows.displayName = 'RuleBuilderRows';

export const RuleBuilderRow = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
...
export const RuleBuilderCols = forwardRef<HTMLDivElement, RuleBuilderColsProps>(({ className, count, ...props }, ref) => {
	const gridColsClass =
		count === 1
			? 'grid grid-cols-1'
			: count === 2
